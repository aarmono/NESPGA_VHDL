...
# Elaboration target
nes_de1_bench: /usr/local/lib/ghdl/std/v08/textio.o /usr/local/lib/ghdl/std/v08/textio-body.o /usr/local/lib/ghdl/ieee/v08/std_logic_1164.o /usr/local/lib/ghdl/ieee/v08/std_logic_1164-body.o /usr/local/lib/ghdl/ieee/v08/numeric_std.o /usr/local/lib/ghdl/ieee/v08/numeric_std-body.o file_bus_types.o utilities.o binary_io.o au_file.o nes_types.o de1_types.o apu_bus_types.o nes_audio_mixer.o simulation.o perhipheral_types.o perhipherals.o sram_bus_types.o cpu_bus_types.o ram_bus_types.o oam_bus_types.o sec_oam_bus_types.o palette_bus_types.o chr_bus_types.o soc.o nes_de1.o bmp_file.o vga_video_record.o nes_de1_bench.o lib_wm8731.o wm8731.o ppu_video_ram_mux.o vga_out.o joy_bus_types.o ppu_bus_types.o prg_bus_types.o nes_core.o mapper_types.o lib_mapper_000.o lib_mapper_002.o lib_nsf_rom.o lib_mapper_220.o lib_mapper.o lib_nes_mmap.o lib_nes.o nes_soc.o nes_soc_ocram.o file_bus_mux.o clk_en.o lib_cpu_types.o lib_cpu_decode_defs.o lib_cpu_decode.o lib_cpu_exec.o lib_cpu.o cpu.o lib_apu_frame_seq.o lib_apu_length.o lib_apu_envelope.o lib_apu_square.o lib_apu_triangle.o lib_apu_noise.o lib_apu_dmc.o lib_apu.o apu.o joystick_io.o lib_ppu.o ppu.o oam_dma.o syncram_sp.o /usr/local/lib/ghdl/ieee/v08/std_logic_arith.o /usr/local/lib/ghdl/ieee/v08/std_logic_unsigned.o /usr/local/lib/ghdl/ieee/v08/std_logic_textio.o sram.o file_memory.o clock.o
	$(GHDL) -e $(GHDLFLAGS) $@
